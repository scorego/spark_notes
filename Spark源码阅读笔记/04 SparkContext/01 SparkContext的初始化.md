...
// 用户设定的jar文件。当部署模式是YARN时，_jars是由spark.jars和spark.yarn.dist.jars指定的jar文件；其他模式下只采用spark.jars指定的jar文件
...
try {
    ...
    // 新建executor的SparkEnv(cache, map output tracker, etc)
